...
namespace Library.Client.Generated
{
    ...
    public static partial class LibraryClientServiceCollectionExtensions
    {
        ...
        public static IOperationClientBuilder AddLibraryClient(
            this IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<ILibraryClient, LibraryClient>();
            ...
            IOperationClientBuilder builder = serviceCollection.AddOperationClientOptions(_clientName)
                .AddResultParser(serializers => new GetDocsResultParser(serializers))
